...
/**
 * Отдаёт соединение в пул, как только ответ отправлен: в рантайме «корутина на запрос» kernel.terminate
 ...
 *
 * Консольная команда под корутинным рантаймом тоже идёт в корутине, но после console.terminate процесс
