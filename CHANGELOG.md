...
- Документация и комментарии: убраны упоминания конкретного рантайма и приватных образов — описание
  привязано к событиям `swoole.*` и матрице публичных образов `phpswoole/swoole`. Кода не касается.
